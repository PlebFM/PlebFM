...
const SpotifyLogo = memo(function SpotifyLogo() {
  return (
...
const SpotifyAuthButton = memo(function SpotifyAuthButton({
  onSuccessRedirect,
  ...
  return (
    <motion.button
      ...
      className={`w-full flex items-center justify-center space-x-3 ${
        isLoading ? 'bg-[#1DB954]/70' : 'bg-[#1DB954] hover:bg-[#1ed760]'
