 ...
 *
 * Only mint with this. Settlement must go through `getProviderByName` using the
 * provider recorded in the invoice's signed reference, otherwise flipping this
 * variable strands invoices that are already in flight.
 */
