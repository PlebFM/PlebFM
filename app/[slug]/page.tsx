...
import {ArrowLeftIcon, ArrowRightIcon, CrossIcon, SearchIcon} from "@bitcoin-design/bitcoin-icons-react/outline"
    ...
    return(
      <>
        ...
        <div className="px-6 py-12 text-white relative z-50 justify-between flex flex-col space-y-6 items-center min-h-screen font-thin">
            ...
            <div className="w-2/3 mx-auto flex flex-col space-y-4 text-center">
              {userProfile.firstNym && userProfile.lastNym ?
                <>
                  ...
                  <p className="text-2xl">{userProfile.firstNym} {userProfile.lastNym}</p>
                </>
                :
                <>
                  <Avatar />
          ...
          <Button size="large" icon={<ArrowRightIcon />} onClick={nextSlide} disabled={!slides[currentSlide].contBtnActive}>Continue</Button>
    ...
    return(
      <>
        ...
        <div className="px-6 py-12 text-white relative z-50 justify-between flex flex-col space-y-6 items-center min-h-screen font-thin">
          ...
          <div className="text-3xl leading-relaxed text-center">
            <p>
              Let’s jam, <strong>{userProfile.firstNym} {userProfile.lastNym}</strong>.
            </p>
          </div>

          <Button size="large" icon={<SearchIcon />} onClick={setUser}>Find a Song</Button>
        </div>
      </>
    )
  }
